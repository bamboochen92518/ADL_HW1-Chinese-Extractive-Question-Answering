...
def parse_args():
    ...
    parser.add_argument(
        "--train_file", type=str, default="train-1-step.json", help="A csv or a json file containing the training data."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--validation_file", type=str, default="valid-1-step.json", help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
    ...
    parser.add_argument("--output_dir", type=str, default="1-to-ans_e3b2_model", help="Where to store the final model.")
