...
def parse_args():
    ...
    parser.add_argument("--do_predict", action="store_true", help="To do prediction on the question answering model", default=False)
    parser.add_argument(
    ...
    parser.add_argument("--output_dir", type=str, default="1-to-ans_e5b8_t2v_model", help="Where to store the final model.")
...
def main():
    ...
    if args.model_name_or_path:
        ...
        model = BertForQuestionAnswering.from_config(config, trust_remote_code=args.trust_remote_code)
